...
def page_mildew_detector_body():
    ...
    st.write(
        f"* A set of healthy and mildew-infected leaves can be downloaded for "
        f"live prediction.\n\n"
        f"Images can be downloaded from [here](https://www.kaggle.com/datasets/codeinstitute/cherry-leaves)"
    )
